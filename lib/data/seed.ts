...
export const labEntities: Omit<Entity, 'id' | 'created_at' | 'updated_at'>[] = [
  { type: 'lab', name: 'OpenAI', slug: 'openai', description: 'Creator of GPT, ChatGPT, Sora, and DALL-E. 910M weekly active users. $25B annualized revenue. 7,200+ employees. The company that kicked off the AI era.', logo_url: null, website: 'https://openai.com', country: 'US', region: 'North America', category: 'Frontier AI', tags: ['frontier', 'llm', 'chatgpt', 'gpt', 'sora'], social_links: { x: 'openai' }, metadata: { founded: 2015, hq: 'San Francisco', valuation: '$500B', employees: '7,216', wau: '910M', arr: '$25B', ceo: 'Sam Altman' }, is_verified: true },
  { type: 'lab', name: 'Anthropic', slug: 'anthropic', description: 'AI safety company behind Claude. $19B annualized revenue. $380B valuation. 4,585 employees. 300K+ business customers. 8 of Fortune 10.', logo_url: null, website: 'https://anthropic.com', country: 'US', region: 'North America', category: 'Frontier AI', tags: ['frontier', 'llm', 'claude', 'safety', 'coding'], social_links: { x: 'anthropicai' }, metadata: { founded: 2021, hq: 'San Francisco', valuation: '$380B', employees: '4,585', arr: '$19B', enterprise: '300K+ customers', ceo: 'Dario Amodei' }, is_verified: true },
  ...
  { type: 'lab', name: 'Meta AI', slug: 'meta-ai', description: 'Open-source AI leader. Llama has 1B+ downloads. Meta AI has 1B MAU. FAIR research in 8 cities. $65B AI spend in 2025. Powering the open-weight revolution.', logo_url: null, website: 'https://ai.meta.com', country: 'US', region: 'North America', category: 'Frontier AI', tags: ['open-source', 'llm', 'llama', 'moe'], social_links: { x: 'metaai' }, metadata: { hq: 'Menlo Park', parent: 'Meta Platforms', llama_downloads: '1B+', meta_ai_mau: '1B', ai_spend: '$65B (2025)', vp_ai: 'Yann LeCun' }, is_verified: true },
  { type: 'lab', name: 'xAI', slug: 'xai', description: 'Elon Musk\'s AI lab. $230B valuation. 64M Grok MAU. 700-1,200 employees. Memphis Supercluster. $500M ARR, projected $2B+ in 2026.', logo_url: null, website: 'https://x.ai', country: 'US', region: 'North America', category: 'Frontier AI', tags: ['frontier', 'llm', 'grok', 'twitter'], social_links: { x: 'xai' }, metadata: { founded: 2023, hq: 'San Francisco', valuation: '$230B', grok_mau: '64M', arr: '~$500M', employees: '700-1,200', ceo: 'Elon Musk' }, is_verified: true },
  { type: 'lab', name: 'DeepSeek', slug: 'deepseek', description: 'Chinese lab that shocked the world. 57.2M app downloads. ~200 employees. $3.4B valuation. $220M ARR. Proved frontier AI can be built for $5.6M.', logo_url: null, website: 'https://deepseek.com', country: 'CN', region: 'Asia', category: 'Frontier AI', tags: ['frontier', 'llm', 'chinese', 'open-source', 'efficient'], social_links: {}, metadata: { founded: 2023, hq: 'Hangzhou', valuation: '$3.4B', downloads: '57.2M', employees: '~200', arr: '$220M', training_cost: '$5.6M' }, is_verified: true },
  { type: 'lab', name: 'Mistral AI', slug: 'mistral', description: 'Europe\'s frontier AI champion. $13.8B valuation. €300M ARR, targeting €1B by end 2026. 862 employees. Le Chat consumer product.', logo_url: null, website: 'https://mistral.ai', country: 'FR', region: 'Europe', category: 'Frontier AI', tags: ['open-weight', 'llm', 'european', 'multilingual'], social_links: { x: 'mistralai' }, metadata: { founded: 2023, hq: 'Paris', valuation: '$13.8B', arr: '€300M', employees: '862', ceo: 'Arthur Mensch' }, is_verified: true },
  { type: 'lab', name: 'Nvidia', slug: 'nvidia', description: 'The backbone of AI. 85% GPU market share. $4.49T market cap. $130B+ annual AI revenue. Jensen Huang net worth $164B. The most important company in AI.', logo_url: null, website: 'https://nvidia.com/ai', country: 'US', region: 'North America', category: 'AI Infrastructure', tags: ['gpu', 'infrastructure', 'nemo', 'cuda'], social_links: { x: 'nvidia' }, metadata: { founded: 1993, hq: 'Santa Clara', market_cap: '$4.49T', gpu_share: '85%', ai_revenue: '$130B+ annual', ceo: 'Jensen Huang', ceo_net_worth: '$164.1B' }, is_verified: true },
  { type: 'lab', name: 'Perplexity AI', slug: 'perplexity', description: 'The answer engine. 30-45M MAU. 780M queries/month. $148M ARR, projected $656M for 2026. $20B valuation. The first real threat to Google Search.', logo_url: null, website: 'https://perplexity.ai', country: 'US', region: 'North America', category: 'AI Search', tags: ['search', 'rag', 'answer-engine', 'consumer'], social_links: { x: 'perplexity_ai' }, metadata: { founded: 2022, hq: 'San Francisco', valuation: '$20B', mau: '30-45M', queries: '780M/mo', arr: '$148M', ceo: 'Aravind Srinivas' }, is_verified: true },
  { type: 'lab', name: 'Hugging Face', slug: 'hugging-face', description: 'The GitHub of AI. 1M+ models hosted. 5M registered users. 18-28M monthly visitors. $130M revenue. Transformers library: 157K GitHub stars.', logo_url: null, website: 'https://huggingface.co', country: 'US', region: 'North America', category: 'AI Platform', tags: ['open-source', 'community', 'models', 'hub'], social_links: { x: 'huggingface' }, metadata: { founded: 2016, hq: 'New York', valuation: '$4.5B', models: '1M+', users: '5M', visitors: '18-28M/mo', revenue: '$130M', github_stars: '157K (transformers)' }, is_verified: true },
...
export const toolEntities: Omit<Entity, 'id' | 'created_at' | 'updated_at'>[] = [
  ...
  { type: 'tool', name: 'Cursor', slug: 'cursor', description: 'AI-first code editor. $2B ARR — doubled in 3 months. 1M+ paying developers. $29.3B valuation. Fastest SaaS revenue growth in history.', logo_url: null, website: 'https://cursor.com', country: 'US', region: 'North America', category: 'AI Coding', tags: ['ide', 'coding', 'editor', 'composer'], social_links: {}, metadata: { arr: '$2B', paying_users: '1M+', valuation: '$29.3B', growth: 'Revenue doubles every ~2 months', investors: 'a16z, Thrive' }, is_verified: true },
  ...
  { type: 'tool', name: 'Midjourney', slug: 'midjourney-app', description: '19.8M registered users. $500M revenue. 26.8% market share. 107-163 employees. $0 VC, $0 ads. Profitable since month 8. The anti-Silicon Valley success story.', logo_url: null, website: 'https://midjourney.com', country: 'US', region: 'North America', category: 'AI Creative', tags: ['image-gen', 'creative', 'design', 'profitable', 'bootstrapped'], social_links: {}, metadata: { users: '19.8M', revenue: '$500M', market_share: '26.8%', employees: '107-163', vc_raised: '$0', ads_spent: '$0' }, is_verified: true },
  ...
  { type: 'tool', name: 'ElevenLabs', slug: 'elevenlabs', description: 'Voice AI platform. $11B valuation. $330M ARR. 41% of Fortune 500 use it. Industry-leading TTS, voice cloning, dubbing.', logo_url: null, website: 'https://elevenlabs.io', country: 'US', region: 'North America', category: 'AI Audio', tags: ['voice', 'tts', 'audio', 'speech', 'dubbing'], social_links: {}, metadata: { valuation: '$11B', arr: '$330M', fortune500: '41%', employees: '~400' }, is_verified: true },
...
export const creatorEntities: Omit<Entity, 'id' | 'created_at' | 'updated_at'>[] = [
  { type: 'creator', name: 'Andrej Karpathy', slug: 'andrej-karpathy', description: 'Ex-Tesla AI Director, OpenAI founding member. 1.3M YouTube subs. 1.9M X followers. Eureka Labs founder (LLM101n). The most respected AI educator alive.', logo_url: null, website: 'https://karpathy.ai', country: 'US', region: 'North America', category: 'AI Educator', tags: ['educator', 'researcher', 'youtube', 'neural-nets'], social_links: { x: 'karpathy', youtube: '@andrejkarpathy' }, metadata: { youtube_subs: '1.3M', x_followers: '1.9M', company: 'Eureka Labs', background: 'Stanford PhD, Tesla, OpenAI founding' }, is_verified: true },
  { type: 'creator', name: 'Fireship', slug: 'fireship', description: 'Jeff Delaney. 4.1M YouTube subs. 785 videos. "100 Seconds" series. Makes complex tech accessible and entertaining. The Jon Stewart of tech.', logo_url: null, website: 'https://fireship.io', country: 'US', region: 'North America', category: 'Tech Content', tags: ['youtube', 'dev', 'explainer', 'humor'], social_links: { x: 'fireship_dev', youtube: '@fireship' }, metadata: { youtube_subs: '4.1M', videos: '785' }, is_verified: true },
